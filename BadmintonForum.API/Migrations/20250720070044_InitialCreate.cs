    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 7, 20, 7, 0, 44, 245, DateTimeKind.Utc).AddTicks(9793), "分享和討論羽毛球技術", 0, "🏸", "技術討論" },
                    { 2, new DateTime(2025, 7, 20, 7, 0, 44, 245, DateTimeKind.Utc).AddTicks(9797), "球拍、球鞋等裝備討論", 0, "🎾", "裝備推薦" },
                    { 3, new DateTime(2025, 7, 20, 7, 0, 44, 245, DateTimeKind.Utc).AddTicks(9798), "比賽和活動信息", 0, "📅", "活動公告" },
                    { 4, new DateTime(2025, 7, 20, 7, 0, 44, 245, DateTimeKind.Utc).AddTicks(9799), "尋找球友，組織活動", 0, "👥", "球友交流" }
                });
